...
<div id="mainBar">
    <div id="topBar">
        ...
        <a id="homeLink" href="http://localhost:8080/htmlPart/Home.jsp"><b>Customer Account Manager </b></a>
    </div>
    <div id="middleBar">
        <div id="rightBar">
            <div id="verticalLinks">
                <ul id="vertLinks">
                    <a class="vertLink">Create New User</a>
                    <a class="vertLink">Search </a>
                    <a class="vertLink">Banking Facilities</a>
                </ul>
        ...
        <div id="leftBar">
            <div id="loginForm">
                <form action="http://localhost:8080/htmlPart/Home_welcome.jsp" align=center>
