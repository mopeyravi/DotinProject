            ...
            <div class="tab_container">
                <div id="tab1" class="tab_content">
                    <form action="/SearchRealCustomerServlet" align=center>
                        <ul>First Name:&ensp;&ensp; &ensp;&ensp;&ensp;<input type="text" name="firstname"></ul>
                        <ul>Last Name: &ensp;&ensp;&ensp;&ensp;&ensp;<input type="text" name="lastname"></ul>
                        <ul>National Code: &ensp;&ensp;<input type="text" name="nationalcode"></ul>
                        <ul>Customer ID:&ensp; &ensp;&ensp;<input type="text" name="customerID"></ul>
                        <br>
                        <ul><input type="submit" value="Search"></ul>
                    </form>
                </div>
                <div id="tab2" class="tab_content">
                    <form action="/SearchLegalCustomerServlet" align=center>
                        ...
                        <ul>Customer ID:&ensp; &ensp;&ensp;&ensp;<input type="text" name="customerID"></ul>
                        <br>
                        <ul><input type="submit" value="Search"></ul>
                    </form>
                </div>
