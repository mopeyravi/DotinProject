    ...
    <div id="middleBar">
        <div id="rightBar">
            <div id="verticalLinks">
                <ul id="vertLinks">
                    <a class="vertLink" href="http://localhost:8080/htmlPart/newUser.jsp">Create New User</a>
                    <a class="vertLink" href="http://localhost:8080/htmlPart/searchUser.jsp">Search </a>
                    <a class="vertLink" href="http://localhost:8080/htmlPart/BankingFacilities.jsp">Banking
                        Facilities</a>
                </ul>
        ...
        <div id="leftBar">
            ...
            <div class="tab_container">
                ...
                <div id="tab2" class="tab_content">
                    ...
                    <%facilities = (LoanType[]) request.getAttribute("facilities");%>
